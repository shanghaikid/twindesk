...
| Real Feishu reply succeeds | Not proven | Durable dispatch, credential rotation, exclusive ownership, fixed reply-scope gates, and the User Keychain probe are covered synthetically; no Bot token/scope acquisition, reply HTTP client, lease-wrapped adapter, or live account |
