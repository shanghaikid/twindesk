...
invokes this Host through a separate approved-action execution control. Hosted
callback or polling, browser-refresh restoration, and an authorized
live-account acceptance run also remain open. Synthetic
